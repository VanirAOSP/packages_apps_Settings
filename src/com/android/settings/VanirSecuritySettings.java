 ...
 */
public class VanirSecuritySettings extends SettingsPreferenceFragment
        implements OnPreferenceChangeListener, DialogInterface.OnClickListener, Indexable {

    private static final String TAG = "VanirSecuritySettings";
    ...
    private PreferenceScreen createPreferenceHierarchy() {
            ...
            if (mOwnerInfoPref != null) {
                mOwnerInfoPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                    ...
                    public boolean onPreferenceClick(Preference preference) {
                        OwnerInfoSettings.show(VanirSecuritySettings.this);
                        return true;
                    }
                });
            }
        ...
        if (mFilterType == TYPE_LOCKSCREEN_EXTRA) {
            ...
            Index.getInstance(getActivity())
                    .updateFromClassNameResource(VanirSecuritySettings.class.getName(), true, true);
        }
    ...
    public boolean onPreferenceChange(Preference preference, Object value) {
        ...
        if (KEY_LOCK_AFTER_TIMEOUT.equals(key)) {
            ...
            try {
                ...
                Log.e("VanirSecuritySettings", "could not persist lockAfter timeout setting", e);
            }
            updateLockAfterPreferenceSummary();
