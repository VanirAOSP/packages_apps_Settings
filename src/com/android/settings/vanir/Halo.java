/*
 * Copyright (C) 2013 VanirAOSP && Paranoid Android
 *
...
public class Halo extends SettingsPreferenceFragment
    ...
    public void onStart() {
        ...
        mEnabledSwitch.setChecked(mEnabledState);
        updateDependency();
    }
    ...
    private void updateDependency() {
        ...
        mHaloNotifDescColor.setEnabled(mEnabledState);
        mHaloSpeechBubbleColor.setEnabled(mEnabledState);
        mHaloTextColor.setEnabled(mEnabledState);
    }
        ...
        if (buttonView == mEnabledSwitch) {
            boolean value = ((Boolean)isChecked).booleanValue();
             Settings.System.putInt(mContext.getContentResolver(),
                    ...
                    value ? 1 : 0);
    //        final String stock = mContext.getString(R.string.halo_switch_toast);
