...
public class VolumeSteps extends SettingsPreferenceFragment implements
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        if (preference == mVolumeStepsAlarm || preference == mVolumeStepsDTMF || preference == mVolumeStepsMusic || preference == mVolumeStepsNotification || preference == mVolumeStepsRing || preference == mVolumeStepsSystem || preference == mVolumeStepsVoiceCall) {
