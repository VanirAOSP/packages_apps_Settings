...
package com.android.settings.vanir.additionalinfo;
...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.additionalinfo_layout);
    ...
    private void addItem(String name, String value, boolean ucWords) {
        if (value != null && value.length() > 0) {
            ...
            if (ucWords) value = AdditionalInfoLib.ucWords(value);
   ...
   private static class CategoryTextView extends TextView {
        public CategoryTextView(Context context, String text) {
            super(context);
            int indent = AdditionalInfoLib.dpToPx(context, 5);
            int pad = AdditionalInfoLib.dpToPx(context, 2);
    ...
    private static class ValueTextView extends TextView {
        public ValueTextView(Context context, String text) {
            super(context);
            int indent = AdditionalInfoLib.dpToPx(context, 20);
            int pad = AdditionalInfoLib.dpToPx(context, 2);
    ...
    private void loadInfo() {
        AdditionalInfo di = new AdditionalInfo(this);
    ...
    @SuppressWarnings("deprecation")
        ...
        mLayout.addView(new SeparatorTextView(this),
                        new LayoutParams(LayoutParams.FILL_PARENT, AdditionalInfoLib.dpToPx(this, 1)));
    }
}
