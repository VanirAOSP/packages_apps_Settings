...
public class AdditionalInfo {
    ...
    public String getProp(String prop) {
       ...
       String s = UNKNOWN;
        try { s = AdditionalInfoLib.shellExec("getprop " + prop).get(0).trim(); }
        catch (IOException e) {}
    ...
    private String gets(String s) {
        ...
        StatFs stat = new StatFs("/system");
        return AdditionalInfoLib.round(
                        AdditionalInfoLib.scaleData(
    ...
    private List<String> getProc(String proc) {
        ...
        try { list = AdditionalInfoLib.shellExec("cat /proc/" + proc); }
        catch (IOException e) {}
        catch (SecurityException e) {}
        return list;
    }
    ...
    public String getProcMemTotal(String scale) {
        ...
        return String.valueOf(AdditionalInfoLib.scaleData(value, parts[0], scale));
    }
