...
public class RecentsSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCurrentStyle = mRecentsCustom.getValue();
    ...
    private final DialogInterface.OnClickListener alertClickListener = new DialogInterface.OnClickListener() {
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        if (RECENTS_CLEAR_ALL.equals(key)) {
            ...
            AlertDialog.Builder bob = null;

            if (value == RecentsConstants.RECENTS_OMNI) {
                //make sure the user didn't uninstall OmniSwitch (stupid users. teehee)

                bob = new AlertDialog.Builder(getActivity());
                bob.setTitle(getResources().getString(R.string.omniswitch_warning_title));
                ...
                if (!couldFind) {
                    bob.setMessage(getResources().getString(R.string.omniswitch_not_installed_message));
                    bob.setNeutralButton(android.R.string.ok, alertClickListener);
                    bob.create().show();
                    //set back to previous (valid) value
                    mRecentsCustom.setValue(mCurrentStyle);
                    return true;
                }
                mCurrentStyle = (String)objValue;
                bob.setMessage(getResources().getString(R.string.omniswitch_enabled_message));
                bob.setPositiveButton(R.string.yes, alertClickListener);
                bob.setNegativeButton(R.string.no, alertClickListener);
            }
