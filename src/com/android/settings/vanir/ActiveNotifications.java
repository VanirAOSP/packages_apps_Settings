...
public class ActiveNotifications extends SettingsPreferenceFragment implements
    ...
    private static final String KEY_ALLOW_WITH_SCREEN_ON = "allow_with_screen_on";
    ...
    private CheckBoxPreference mAllowWithScreenOn;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAllowWithScreenOn = (CheckBoxPreference) prefs.findPreference(KEY_ALLOW_WITH_SCREEN_ON);
        mAllowWithScreenOn.setChecked(Settings.System.getInt(cr,
                    Settings.System.FLASH_NOTIFICATIONS_ALLOW_WITH_SCREEN_ON, 1) == 1);
    ...
    private void updateDependency() {
		...
		mAllowWithScreenOn.setEnabled(mActiveNotifications && mFlashNotifications.isChecked());
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
		...
		} else if (preference == mAllowWithScreenOn) {
			Settings.System.putInt(mContext.getContentResolver(), Settings.System.FLASH_NOTIFICATIONS_ALLOW_WITH_SCREEN_ON,
					mAllowWithScreenOn.isChecked() ? 1 : 0);
    ...
    Set<String> getExcludedNotifApps(String setting) {
        ...
        if (TextUtils.isEmpty(excludedNotif) || excludedNotif == null) return null;
