...
public class NavbarSettingsFragment extends Fragment implements SeekBar.OnSeekBarChangeListener,
    ...
    private static final HashMap<Integer, String> mIMEKeyMap = new HashMap<Integer, String>() {{
        put(1,"**back**,,,");
        put(2,"**ime**,,,");
        put(3,"**home**,,,");
        put(4,"**blank**,,,");
    ...
    private void updatePreferenceSummaries() {
        ...
        TextView layoutSummary = (TextView) mLayoutView.findViewById(R.id.alternate_layout_text);
