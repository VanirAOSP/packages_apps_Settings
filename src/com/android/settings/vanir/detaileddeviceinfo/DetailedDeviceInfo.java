...
public class DetailedDeviceInfo {
    ...
    public String getProp(String prop) {
       ...
       String s = UNKNOWN;
        try { s = DetailedDeviceInfoLib.shellExec("getprop " + prop).get(0).trim(); }
        catch (IOException e) {}
    ...
    public DetailedDeviceInfo(Context context) {
    ...
    private String gets(String s) {
        ...
        StatFs stat = new StatFs("/system");
        return DetailedDeviceInfoLib.round(
                        DetailedDeviceInfoLib.scaleData(
    ...
    private List<String> getProc(String proc) {
        ...
        try { list = DetailedDeviceInfoLib.shellExec("cat /proc/" + proc); }
        catch (IOException e) {}
        catch (SecurityException e) {}
        return list;
    }
    ...
    public String getProcMemTotal(String scale) {
        ...
        return String.valueOf(DetailedDeviceInfoLib.scaleData(value, parts[0], scale));
    }
