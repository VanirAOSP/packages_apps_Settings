...
package com.android.settings.vanir.detaileddeviceinfo;
...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detaileddeviceinfo_layout);
    ...
    private void addItem(String name, String value, boolean ucWords) {
        if (value != null && value.length() > 0) {
            ...
            if (ucWords) value = DetailedDeviceInfoLib.ucWords(value);
   ...
   private static class CategoryTextView extends TextView {
        public CategoryTextView(Context context, String text) {
            super(context);
            int indent = DetailedDeviceInfoLib.dpToPx(context, 5);
            int pad = DetailedDeviceInfoLib.dpToPx(context, 2);
    ...
    private static class ValueTextView extends TextView {
        public ValueTextView(Context context, String text) {
            super(context);
            int indent = DetailedDeviceInfoLib.dpToPx(context, 20);
            int pad = DetailedDeviceInfoLib.dpToPx(context, 2);
    ...
    private void loadInfo() {
        DetailedDeviceInfo di = new DetailedDeviceInfo(this);
    ...
    @SuppressWarnings("deprecation")
        ...
        mLayout.addView(new SeparatorTextView(this),
                        new LayoutParams(LayoutParams.FILL_PARENT, DetailedDeviceInfoLib.dpToPx(this, 1)));
    }
}
