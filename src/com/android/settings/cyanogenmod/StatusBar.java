...
public class StatusBar extends SettingsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAlarmIcon = (CheckBoxPreference) findPreference(ALARM_ICON);
        mAlarmIcon.setChecked(Settings.System.getInt(resolver, Settings.System.ALARM_ICON_PREFERENCE, 1) == 1);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        } else if (preference == mAlarmIcon) {
            value = mAlarmIcon.isChecked();
            Settings.System.putInt(getContentResolver(),
